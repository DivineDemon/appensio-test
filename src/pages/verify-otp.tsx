...
import { useForgotPasswordMutation, useVerifyBusinessOTPMutation } from "@/store/services/auth";
...
const VerifyOTP = () => {
  ...
  const { forgotEmail } = useSelector((state: RootState) => state.global);
  const [verify, { isLoading: verifying }] = useVerifyBusinessOTPMutation();
