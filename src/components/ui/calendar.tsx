import { ArrowDown, ArrowLeft, ArrowRight } from "iconsax-react";
    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return <ArrowLeft size={16} color="#000000" className={cn("size-4", className)} {...props} />;
          }

          if (orientation === "right") {
            return <ArrowRight size={16} color="#000000" className={cn("size-4", className)} {...props} />;
          }

          return <ArrowDown size={16} color="#000000" className={cn("size-4", className)} {...props} />;
        },
